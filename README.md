...
Let's get to work on building this thing!

### Steps

- [React Giphy Searcher Project Tutorial](#react-giphy-searcher-project-tutorial)
...
1. Change into your `sei/homework` directory with:
...
```bash
cd ~/sei/homework/react-giphy-searcher
```
...
_Source: [Jennifer Meade}(https://git.generalassemb.ly/jmeade11)_